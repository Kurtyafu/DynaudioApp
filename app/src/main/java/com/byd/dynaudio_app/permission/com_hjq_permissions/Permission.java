package com.byd.dynaudio_app.permission.com_hjq_permissions;

import android.os.Build;

import androidx.annotation.Nullable;

import com.byd.dynaudio_app.permission.handle.AlertWindowHandle;
import com.byd.dynaudio_app.permission.handle.Handle;
import com.byd.dynaudio_app.permission.handle.InstallPackagesHandle;
...
public class Permission {
    static public class Item {
        ...
        @Nullable
        public final com.byd.dynaudio_app.permission.handle.Handle Handle;
    ...
    public static final String MANAGE_EXTERNAL_STORAGE = Reg("android.permission.MANAGE_EXTERNAL_STORAGE","安卓13读写");
