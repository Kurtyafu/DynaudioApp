...
public class PlayView extends FrameLayout {
    ...
    public interface VideoPlayerListener extends IMediaPlayer.OnPreparedListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnErrorListener {
        @Override
